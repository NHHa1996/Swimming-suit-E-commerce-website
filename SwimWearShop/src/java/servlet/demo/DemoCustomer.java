...
import controller.servlet.customer.CustomerLogin;
 ...
 * @author USER
 */
@WebServlet(name = "DemoCustomer", urlPatterns = {"/DemoCustomer"})
public class DemoCustomer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String emailInput = "cuongvip1295@yahoo.com.vn";
        String passwordInput = "12101995";
